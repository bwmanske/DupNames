...
public:
	...
	static bool DoesSectionExist(string SectionName, string FileName);
...
private:
	...
	struct RecordSectionIs : std::function<bool(Record)>
	{
		std::string section_;
	...
	struct RecordSectionKeyIs : std::function<bool(Record)>
	{
		std::string section_;
		std::string key_;
